...
この記事では、個人のGmailアカウントで「受信トレイ in:inbox にある、指定日[X]日より前のメール」を毎日自動で削除する方法を紹介します。
:::message
**ポイント**
今回は指定日[X]=30として紹介します。
:::
...
1. Apps Scriptエディタの左側メニューから時計アイコンの「トリガー」を開く
...
まずはシンプルな形で安定運用し、慣れてきたら条件や通知方法を少しずつチューニングしていくと無理がありません。
