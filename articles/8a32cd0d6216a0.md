---
title: "【Mailpit/Mial.tm】Laravel開発でメール送信機能実装に役立つツール"
emoji: "📪"
type: "tech" # tech: 技術記事 / idea: アイデア
topics: ["Mailpit","MialTm"]
published: false
---
...
この記事では、Laravel アプリ開発を例に、ローカル開発環境における簡易メール送信機能テストツール「Mailpit」と捨てメールアドレス発行ツール「Mail.tm」の導入方法と使い方を紹介します。
