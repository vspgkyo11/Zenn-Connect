...
このガイドは「どう作業するか（How）」をまとめたものです。「なぜそう決めたか（Why）」は
[docs/adr/](./adr/README.md) に記録しているので、判断の背景を知りたいときはそちらを参照してください。
...
リネームすると何が失われるか等の詳しい理由は [ADR-0001](./adr/0001-never-rename-published-article-slugs.md) を参照してください。
